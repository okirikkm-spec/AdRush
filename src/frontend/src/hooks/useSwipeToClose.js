  ...
  useEffect(() => {
    ...
    const isInteractive = (target) => {
      for (let n = target; n && n !== el; n = n.parentElement) {
        ...
        if (n.classList && (n.classList.contains("modal-overlay") || n.classList.contains("gallery-thumbs") || n.classList.contains("drink-hero") || n.classList.contains("rate-slider"))) return true;
      }
      return false;
    };
